...
/**
 * UI.tsx
 * Header (improved illustrated search), Footer, BookCard
 */
    ...
    <header className="w-full sticky top-0 z-50">
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {/* tiny stylized book icon (SVG) */}
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-white">
              <path d="M4 19.5C4 18.12 5.12 17 6.5 17H19" stroke="white" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M4 6.5C4 7.88 5.12 9 6.5 9H19" stroke="white" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M6.5 3v18" stroke="white" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        ...
        {/* center: illustrated search (pill) */}
        <div className="flex-1">
          <div
            className="
              ...
              rounded-full
              shadow-[0_6px_20px_rgba(48,56,79,0.08)]
              px-4 py-2
              flex items-center gap-3
              transition-all
              hover:shadow-[0_10px_30px_rgba(48,56,79,0.10)]
            "
          >
            <div className="flex items-center gap-3">
              {/* small decorative sticker (circle) */}
              <span className="w-9 h-9 rounded-full bg-gradient-to-br from-yellow-100 to-yellow-300 flex items-center justify-center -ml-1">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-yellow-800">
            ...
            <button
              ...
              onClick={() => {
                /* placeholder — conectar búsqueda real luego */
...
/* Footer — slightly illustrated */
export function Footer() {
  return (
    <footer className="border-t mt-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-6 py-8 text-center">
        <p className="text-sm text-gray-600">
          Librerity © {new Date().getFullYear()} — Tu librería online sin comisiones
        </p>
      </div>
    </footer>
  );
...
/* BookCard — polished illustrated style */
  ...
  return (
    <article
      className="
        ...
        p-4 hover:shadow-[0_14px_40px_rgba(15,23,42,0.08)]
        transition transform hover:-translate-y-1
      "
    >
      <div className="relative overflow-hidden rounded-xl">
        <img src={image || "/placeholder-book.png"} alt={title} className="w-full h-52 object-cover rounded-xl" />
        {/* small sticker */}
